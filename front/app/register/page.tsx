...
export default function RegisterPage() {
  ...
  return (
    <div className="container-page max-w-md">
      ...
      <p className="text-sm text-muted mb-6">Зарегистрируйтесь как владелец, чтобы сдавать авто.</p>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="text-xs font-medium text-muted mb-1 block">Ваше имя</label>
          <input
            value={name}
        ...
        <div>
          <label className="text-xs font-medium text-muted mb-1 block">Логин</label>
          <input
            value={login}
