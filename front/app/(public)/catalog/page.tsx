                        ...
                        <div className="flex-1 space-y-8">
                            ...
                            {filteredCars.length === 0 && (
                                <div className="text-center py-32 bg-white rounded-[3rem] border border-dashed border-slate-200 shadow-sm flex flex-col items-center animate-in fade-in zoom-in duration-500">
                                    ...
                                    <Link href="/find" className="mt-4 text-primary font-medium hover:underline">
                            ...
                            {filteredCars.length > 0 && totalPages > 1 && (
                                <div className="flex justify-center items-center gap-3 pt-6 border-t border-slate-100 mt-8 mb-4">
                                    <Button
                                        variant="outline"
                                        disabled={page === 1}
                            ...
                            {filteredCars.length > 0 && (
                                <div className="text-center py-8">
                                    <Link href="/find" className="text-primary font-medium hover:underline">
