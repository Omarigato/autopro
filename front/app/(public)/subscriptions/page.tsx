...
const getPlanIcon = (name: string) => {
    ...
    if (n.includes('free') || n.includes('бесплат')) return <Zap className="w-12 h-12 text-slate-500 fill-slate-50" />;
    if (n.includes('business') || n.includes('бизнес')) return <Rocket className="w-12 h-12 text-slate-600 fill-slate-50" />;
    return <Shield className="w-12 h-12 text-slate-600 fill-slate-50" />;
};
        ...
        <div className="min-h-screen bg-slate-50/30 pb-20">
            ...
            <section className="bg-black py-32 text-white text-center relative overflow-hidden">
                ...
                <div className="container relative z-10 space-y-6">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-md rounded-full text-slate-300 text-sm font-bold border border-white/10">
                        <Sparkles size={16} />
            ...
            <div className="container -mt-20 relative z-20 px-4 mx-auto">
                {isLoading ? (
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="bg-white rounded-[2.5rem] h-[600px] animate-pulse shadow-xl shadow-slate-200/50" />
                        ))}
                    </div>
                ) : (
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        isPremium
                                            ? "shadow-2xl shadow-slate-200/50 border-2 border-slate-300 relative"
                                ...
                                >
                                    ...
                                    <div className="mb-10 text-center flex flex-col items-center">
                                        <div className={cn(
                                            ...
                                            isPremium ? "bg-slate-100" : "bg-slate-50"
                                        )}>
                                        ...
                                        <div className="mt-4 flex flex-col items-center">
                                            <div className="flex items-baseline gap-1">
                                                <span className="text-5xl font-black tracking-tighter text-slate-900">{plan.price.toLocaleString()} ₸</span>
                                            </div>
                                        ...
                                        {getPlanFeatures(plan.name).map((feature, i) => (
                                            <div key={i} className="flex items-start gap-4">
                                                <div className={cn(
                                                    ...
                                                    isPremium ? "text-slate-600" : "text-slate-400"
                                                )}>
                ...
                <div className="mt-32 text-center max-w-4xl mx-auto space-y-10 px-4">
                    <div className="space-y-4">
                        <div className="inline-flex p-4 bg-slate-100 text-slate-600 rounded-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
                        <Button
                            variant="outline"
                            size="lg"
                            className="w-full sm:w-auto rounded-2xl px-10 h-16 border-2 border-slate-200 text-slate-700 hover:bg-slate-100 font-black text-lg gap-3"
                        >
                        ...
                        <Button
                            variant="ghost"
                            size="lg"
                            className="w-full sm:w-auto rounded-2xl px-10 h-16 text-slate-600 hover:text-slate-800 hover:bg-slate-100 font-black text-lg gap-3"
                        >
                            <HelpCircle size={22} />
                            Помощь и FAQ
                        </Button>
